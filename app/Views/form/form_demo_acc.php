			                ...
			                <div class="inner">
                                ...
                                <div class="form-row form-row-date">
									<div class="form-holder form-holder-2">
										<label for="date" class="special-label">MetaTrader Type*</label>
										<select name="date" id="date" class="form-control">
											<option value="MT5" selected>MT5</option>
											<option value="MT4">MT4</option>
											<option value="Vertex">Vertex</option>
										</select>
                                    </div>
                                    <div class="form-holder form-holder-2">
										<label for="date" class="special-label">Account Type*</label>
										<select name="month" id="month" class="form-control">
											<option value="SigmateUSD1" selected>SigmateUSD1</option>
											<option value="SigmateEUR1">SigmateEUR1</option>
											<option value="SigmateEUR1">Demo</option>
										</select>
                                    </div>                                   
								</div>
                                <div class="form-row form-row-date">
                                    <div class="form-holder form-holder-2">
										<label for="date" class="special-label">Currency*</label>
                                    ...
                                    <div class="form-holder form-holder-2">
										<label for="date" class="special-label">Leverage*</label>
										<select name="year" id="year" class="form-control">
                                    ...
                                    <div class="form-holder form-holder-2">
										<label for="date" class="special-label">Balance*</label>
										<select name="year" id="year" class="form-control">
								...
								<div class="form-row">
									...
									<div class="form-holder">
										<label class="form-row-inner">
											<input type="text" name="verf_code" id="verf_code" class="form-control" required/>
